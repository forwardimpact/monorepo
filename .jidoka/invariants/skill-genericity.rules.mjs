...
export default {
  ...
  rules: ({ failAll }) => [
    ...
    failAll("agent-naming", {
      ...
      hint: "the x- filename prefix and the frontmatter classifier must agree (JIDOKA.md § L4): every x-*.md has no agent frontmatter, and every profile has name+description and is not named x-*",
    }),
  ],
};
