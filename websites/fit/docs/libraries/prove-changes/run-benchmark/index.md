...
count, and the absolute paths to both NDJSON traces. The harness validates
the record's schema at write time. It catches a malformed write before the
report stage trips over it.
