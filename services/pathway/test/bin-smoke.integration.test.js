...
// cask user has. Each token must print output and exit 0. No token binds a
// port. The telemetry logger writes the "listening" log line to stderr, so
...
describe("fit-svcpathway bin smoke", () => {
