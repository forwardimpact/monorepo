...
List tags with `gh api repos/forwardimpact/kata-agent/tags` (also `gemba-bootstrap`,
`gemba-harness`, and `gemba-wiki` for `workflow-dispatch.md`). Pick the highest `vX.Y.Z`.
