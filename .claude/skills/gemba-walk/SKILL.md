...
description: >
  ...
  a structured findings report. "Go see, ask why, show respect." Use when the
  user says "gemba walk", "walk a trace", "analyze a workflow run", "review
  agent trace", "what happened in the last run", "coaching cycle", or "inspect
  a CI run".
---
