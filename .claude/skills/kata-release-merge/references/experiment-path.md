...
Only a PR that passed the approval read above reaches this check. This check
replaces the "parent spec plan on main" check. Compare the PR's changed-file
list against the execution-plan globs recorded on the experiment issue at
registration:
