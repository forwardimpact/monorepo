...
`wiki/metrics/kata-documentation/2026.csv` tagged `kata-documentation-cross-page-consistency-sh-output-reexec` per divergence; scope: `<sh>+<text>` pairs only, staleness-class-3 stays local-to-topic.
