...
export function baseRecord(overrides) {
  return {
    ...
    costUsd: 0,
    turns: 1,
    rawTracePath: "runs/sample/0/trace--sample-r0.raw.ndjson",
    agentTracePath: "runs/sample/0/trace--sample-r0--agent.agent.ndjson",
    supervisorTracePath:
      "runs/sample/0/trace--sample-r0--supervisor.supervisor.ndjson",
    judgeTracePath: "runs/sample/0/trace--sample-r0--judge.judge.ndjson",
