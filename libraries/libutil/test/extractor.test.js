...
describe("TarExtractor", () => {
  ...
  describe("constructor", () => {
    test("creates a TarExtractor with fs and path", () => {
    ...
    test("validates the path parameter", () => {
  ...
  describe("extract", () => {
    test("extracts the tar.gz archive to the specified directory", async () => {
    ...
    test("extracts files with the correct content", async () => {
      const tarPath = path.join(fixturesDir, "sample.tar.gz");
    ...
    test("creates the nested directory structure", async () => {
      const tarPath = path.join(fixturesDir, "sample.tar.gz");
    ...
    test("handles a non-existent output directory", async () => {
      const tarPath = path.join(fixturesDir, "sample.tar.gz");
      const outputDir = path.join(tempDir, "deep", "nested", "tar-output");

      // The extractor should not throw. It should create the directory
      // structure.
      await extractor.extract(tarPath, outputDir);
...
describe("ZipExtractor", () => {
  ...
  describe("constructor", () => {
    test("creates a ZipExtractor with fs and path", () => {
  ...
  describe("extract", () => {
    test("extracts the zip archive to the specified directory", async () => {
    ...
    test("throws an error for an invalid zip file", async () => {
  ...
  describe("format comparison", () => {
    ...
    test("both extractors create an identical directory structure", async () => {
      const tarPath = path.join(fixturesDir, "sample.tar.gz");
      const zipPath = path.join(fixturesDir, "sample.zip");
