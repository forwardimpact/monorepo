...
| `polaris-site` | builds `products/polaris/site/` (placeholder Dockerfile in this part) | 3001:3000 | `curl -f http://localhost:3000/api/health` | `kong` |
| `polaris-functions` | builds `services/polaris-functions/` (placeholder Dockerfile) | 8082:8000 | `curl -f http://localhost:8000/health` | `kong`, `tei` |
