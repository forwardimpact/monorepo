...
gh repo create forwardimpact/bionova-apps --public \
  --description "BioNova clinical trial finder — reference consumer of Forward Impact libraries"
...
| `LICENSE` | Apache-2.0 |
| `.gitignore` | `node_modules/`, `data/synthetic/output/`, `.env`, `*.log`, `infrastructure/*/data/` |
| `.nvmrc` | `20` (Node major) |
| `.tool-versions` | `bun 1.2.0`, `nodejs 20.11.1` |
| `package.json` | Workspace root; private; `workspaces: ["products/*/cli", "products/*/site", "products/*/handlers", "services/*"]` (no top-level `products/*` glob — each product surface is its own workspace) |
| `bun.lockb` | (generated by `bun install` after part-01 dependencies declared) |
| `justfile` | Recipes: `up` (`docker compose up -d`), `down`, `setup` (`./setup.sh`), `terrain` (`bunx fit-terrain generate`), `cli` (`node products/finder/cli/bin/bionova-finder.js`), `dev:site`, `test`, `lint` |
...
```json
{
  ...
  "private": true,
  "type": "module",
  "workspaces": ["products/*/cli", "products/*/site", "products/*/handlers", "services/*"],
  "engines": { "node": ">=20", "bun": ">=1.2" },
  "scripts": {
    "setup": "./setup.sh",
    "lint": "bun run lint --filter='./products/*' --filter='./services/*'",
    "test": "bun test"
  },
  "devDependencies": {
...
```
data/synthetic/               # story.dsl + terrain output (part 03)
