...
| `people push` (adapted) | `products/map/src/commands/people.js` + people parse/transform | Sole writer of `organization_people.team_id` from the roster (the people parser/transform gain a `team_id` field; moved off GetDX ingestion). |
