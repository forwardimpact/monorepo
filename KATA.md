...
is the daily proof that the substrate is generic and that another team could run
on it.
...
Deleting the variable also resumes the team, but it forfeits the watchdog's
quiet window below.
