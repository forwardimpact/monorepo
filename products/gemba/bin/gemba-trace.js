...
const definition = {
  ...
  examples: [
    ...
    "gemba-trace split structured.json --mode=facilitate",
    "gemba-trace overview --file structured.json",
    "gemba-trace overview --file structured.json --format json",
    "gemba-trace timeline --file structured.json",
    "gemba-trace stats --file structured.json --by-tool",
    "gemba-trace cost trace.ndjson",
    "gemba-trace cost trace.ndjson --markdown",
    "gemba-trace tool structured.json Conclude",
    "gemba-trace tool-calls --file structured.json",
    "gemba-trace commands --file structured.json --match '^git'",
    "gemba-trace paths --file 'traces/*.ndjson' --prefix /app",
    "gemba-trace compare trace-a.ndjson trace-b.ndjson",
    "gemba-trace search structured.json 'error|fail' --context 1",
    "gemba-trace filter --file structured.json --tool Bash --error",
    "gemba-trace turn structured.json 3",
