...
import { runOutputCommand } from "@forwardimpact/libharness/commands/output.js";
import { runTeeCommand } from "@forwardimpact/libharness/commands/tee.js";
import { runRunCommand } from "@forwardimpact/libharness/commands/run.js";
import { runSuperviseCommand } from "@forwardimpact/libharness/commands/supervise.js";
import { runFacilitateCommand } from "@forwardimpact/libharness/commands/facilitate.js";
import { runDiscussCommand } from "@forwardimpact/libharness/commands/discuss.js";
import { runCallbackCommand } from "@forwardimpact/libharness/commands/callback.js";
import { runScanLogsCommand } from "@forwardimpact/libharness/commands/scan-logs.js";
...
const definition = {
  ...
  examples: [
    ...
    "gemba-harness run --task-file=task.md --work-tracker=filesystem --output=trace.ndjson",
    "gemba-harness supervise --task-file=task.md --lead-profile=judge --agent-profile=coder --output=trace.ndjson",
    'gemba-harness facilitate --task-file=task.md --lead-profile=lead --agent-profiles="security-engineer,technical-writer" --output=trace.ndjson',
    'gemba-harness discuss --task-file=task.md --lead-profile=release-engineer --agent-profiles="staff-engineer,security-engineer" --discussion-id=GD_kw...',
    "gemba-harness output --format=text < trace.ndjson",
  ],
  documentation: [
    {
